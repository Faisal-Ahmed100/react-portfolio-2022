      ...
      <div className="flex items-center flex-col md:flex-row gap-5 justify-between w-full md:h-full">
        <div className="flex flex-col md:pl-12 order-2 md:order-1 mt-6 md:mt-0 md:absolute xl:static">
          ...
          <div className="flex justify-start items-start flex-row gap-5 mb-12 md:mb-0">
            <button className="uppercase bg-[#6c5ce7] border-2 border-[#6c5ce7] transition-all ease-linear text-white text-sm px-5 rounded-sm py-3 hover:border-2 hover:border-[#6c5ce7] hover:bg-white font-medium hover:text-[#6c5ce7]">heir me</button>
