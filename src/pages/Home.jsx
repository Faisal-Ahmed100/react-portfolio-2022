...
const Home = () => {
  return (
    <section className="w-full lg:h-full xl:min-h-screen md:h-screen  flex justify-center items-center">
      <div className="flex items-center flex-col md:flex-row gap-5 justify-between w-full md:h-full">
        <div className="flex flex-col md:pl-12 order-2 md:order-1 mt-6 md:mt-10 md:absolute xl:static">
          ...
          <h2 className="sm:text-4xl md:text-4xl text-2xl capitalize font-bold mt-1 text-gray-700 ">
            Creative <span className="text-[#6c5ce7] animate-pulse">web </span>
            Designer & Developer
          </h2>
          <p className="md:py-6 py-4 text-lg text-gray-600 capitalize">
            I am a <span className="text-[#6c5ce7]">React js</span> and
            <span className="text-[#6c5ce7]"> next js </span> front-end
            Developer and Designer since 2018. and i have muce more experience
            in front-end web development. I do my client's projects sincerely.
          </p>
          ...
          <div className="flex justify-start items-start flex-row gap-5 mb-12 md:mb-0">
            ...
            <Link to="/portfolios">
              <button className="uppercase hover:bg-[#6c5ce7] hover:text-white transition-all ease-linear text-sm px-5 rounded-sm py-3 font-medium border-2 border-[#6c5ce7] bg-transparent text-[#6c5ce7]">
                My portfolio
              </button>
            </Link>
          </div>
        ...
        <div className="w-full h-[90vh] sm:h-screen -mt-[120px] sm:-mt-30 md:mt-0 order-1 md:order-2 heroImg">
          <img
            className="h-full w-full sm:h-[90%] md:w-full object-cover "
            src={BannerImg}
            alt="Banner img"
          />
        </div>
